...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Details_t, stringdata) + ofs \
...
const QMetaObject Details::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Details.data,
      qt_meta_data_Details,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Details.stringdata))
