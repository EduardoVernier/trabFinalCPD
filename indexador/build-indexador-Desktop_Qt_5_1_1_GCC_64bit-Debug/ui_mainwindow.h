...
=======
    QPushButton *ascAlfa;
>>>>>>> 90f34d7e9882ada4207fca33802eefd5820c455e
...
=======
        ...
        searchButton = new QPushButton(centralWidget);
        searchButton->setObjectName(QStringLiteral("searchButton"));
        searchButton->setGeometry(QRect(680, 70, 91, 41));
        searchButton->setStyleSheet(QLatin1String("QPushButton#searchButton {\n"
"	outline: none;\n"
"    background: #555555;\n"
"	color: #ffffff;\n"
...
" }"));
        descAlfa = new QPushButton(centralWidget);
        descAlfa->setObjectName(QStringLiteral("descAlfa"));
        descAlfa->setGeometry(QRect(580, 120, 41, 41));
        descAlfa->setStyleSheet(QLatin1String("QPushButton#descAlfa{\n"
"	outline: none;\n"
"	background: #f3f3f3;\n"
...
"}"));
        Logo = new QLabel(centralWidget);
        Logo->setObjectName(QStringLiteral("Logo"));
        Logo->setGeometry(QRect(380, 10, 201, 51));
        QFont font;
...
=======
        ...
        searchBar = new QLineEdit(centralWidget);
        searchBar->setObjectName(QStringLiteral("searchBar"));
        searchBar->setGeometry(QRect(270, 70, 401, 41));
        searchBar->setStyleSheet(QStringLiteral("outline: none;"));
        ascAlfa = new QPushButton(centralWidget);
        ascAlfa->setObjectName(QStringLiteral("ascAlfa"));
        ascAlfa->setGeometry(QRect(630, 120, 41, 41));
...
=======
        ___qtablewidgetitem1->setText(QApplication::translate("MainWindow", "Artigos em publica\303\247oes", 0));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
